...
def data_tab(request):
    ...
    df = pd.read_csv("C:\\Users\\jpree\\OneDrive\\Documents\\chocolate.csv")
...
def box_plot(request):
    ...
    default_category = 'Company Location'
    default_value = 'Review Date'
...
def exploratory_data_analysis_tab(request):
    ...
    default_x_feature = 'Rating'
    default_y_feature = 'Review Date'
    ...
    fig_scatter = px.scatter(df, x=selected_x_feature, y=selected_y_feature, color='Rating',
    ...
    default_feature_pie = 'Cocoa Percent'
